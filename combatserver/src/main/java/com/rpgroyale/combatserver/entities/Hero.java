...
public class Hero {
    ...
    public int getMinAutoDamage() {
        if(getAttackType().equals("physical"))
            return (baseStrength + bonusStrength) * 1;
        else if (getAttackType().equals("magic"))
            return (baseIntelligence + bonusIntelligence) * 1;
        else
            return 0;
    }

    public int getMaxAutoDamage() {
        if(getAttackType().equals("physical"))
            return (baseStrength + bonusStrength) * 2;
        else if (getAttackType().equals("magic"))
            return (baseIntelligence + bonusIntelligence) * 2;
        else
            return 0;
    }
